...
class App(tk.Tk):
    ...
    def _run_relocate(self, console, dry):
        ...
        if dry:
            args.append("--dry-run")
        self._run_script(console, "relocate.py", args)
    ...
    def _run_cleanup(self, console, dry):
        ...
        if dry:
            args.append("--dry-run")
        self._run_script(console, "cleanup.py", args)
    ...
    def _build_page_remove_missing(self):
        ...
        self._dry_run_button(
            ...
            lambda: self._run_script(console, "remove_missing.py", ["--dry-run"]),
        )
        self._run_button(
    ...
    def _confirm_run_remove_missing(self, console):
        if messagebox.askyesno(
            ...
            self._run_script(console, "remove_missing.py", [])
