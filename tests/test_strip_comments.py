...
- WAV/AIFF files are not processed (skipped silently by the crawler)
"""
...
# ---------------------------------------------------------------------------
# WAV / AIFF not processed by crawler
# ---------------------------------------------------------------------------


def test_wav_file_not_processed(tmp_path):
    """The crawler skips .wav files — no process_flac or process_mp3 called."""
...
def test_aiff_file_not_processed(tmp_path):
    """The crawler skips .aiff files — no process_flac or process_mp3 called."""
    from scripts.strip_comment_urls import crawl
